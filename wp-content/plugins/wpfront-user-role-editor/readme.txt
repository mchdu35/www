...
* ACF, Woo and bbPress compatibility fixes.

= 4.2.0 =
* Term level permissions.
* Navigation menu permissions compatibility fixes.
* Multisite settings defect fix.
* Multisite propagate users defect fix.
